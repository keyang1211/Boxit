...
public enum Action
{
    ...
    */
    ...
    public final int agentYDelta; // vertical displacement of agent (-1,0,+1)
    public final int agentXDelta; // horisontal displacement of agent (-1,0,+1)
    public final int boxYDelta; // vertical diplacement of box (-1,0,+1)
    public final int boxXDelta; // horisontal displacement of box (-1,0,+1)

    Action(String name, ActionType type, int ard, int acd, int brd, int bcd)
    {
        this.name = name;
        this.type = type;
        this.agentYDelta = ard; 
        this.agentXDelta = acd; 
        this.boxYDelta = brd; 
        this.boxXDelta = bcd;  
    }
